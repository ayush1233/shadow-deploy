...
public class MetricsController {
    ...
    public ResponseEntity<?> getMetricsSummary(
        ...
        List<Map<String, Object>> topEndpointsRaw = comparisonRepository.getTopEndpointsSince(since);
        ...
        List<Long> deltas = comparisonRepository.getLatencyDeltasSince(since);
